package org.dcarew.pythontools.ui.search;
...
public class PythonSearchPage extends DialogPage implements ISearchPage {
  ...
  private static class SearchPatternData {
    public static SearchPatternData create(IDialogSettings settings) {
      ...
      String[] fileNamePatterns = settings.getArray("fileNamePatterns");
    ...
    public void store(IDialogSettings settings) {
      settings.put("ignoreCase", !isCaseSensitive);
      settings.put("isRegExSearch", isRegExSearch);
      settings.put("textPattern", textPattern);
      settings.put("fileNamePatterns", fileNamePatterns);
  ...
  public static final String EXTENSION_POINT_ID = "org.dcarew.pythontools.ui.searchPage";
